...
public class Movement: MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            transform.Translate(Vector3.left * Time.deltaTime * Input.GetAxis("Horizontal") * -15);
        }
        if (Input.GetKey(KeyCode.UpArrow))
        {
            transform.Translate(Vector3.forward * Time.deltaTime * Input.GetAxis("Vertical") * 15);
        }
        if (Input.GetKey(KeyCode.RightArrow))
        {
            transform.Translate(Vector3.right * Time.deltaTime * Input.GetAxis("Horizontal") * 15);
        }
        if (Input.GetKey(KeyCode.DownArrow))
        {
            transform.Translate(Vector3.back * Time.deltaTime * Input.GetAxis("Vertical") * -15);
        }
